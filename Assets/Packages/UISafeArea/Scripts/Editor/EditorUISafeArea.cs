...
public class EditorUISafeArea : Editor {
	...
	public override void OnInspectorGUI() {
		...
		Object canvasScalerObject = EditorGUILayout.ObjectField(safeArea.CanvasScaler, typeof(CanvasScaler), true);

		safeArea.CanvasScaler = canvasScalerObject as CanvasScaler;
		

		if (safeArea.CanvasScaler != null) {
